...
function(ament_cmake_symlink_install_directory cmake_current_source_dir)
  ...
  if(NOT IS_ABSOLUTE "${ARG_DESTINATION}")
    set(ARG_DESTINATION "/home/toby/ThirdYearProject/ros2TurtleBot3_ws/install/hls_lfcd_lds_driver/${ARG_DESTINATION}")
  endif()
...
function(ament_cmake_symlink_install_targets)
  ...
  foreach(file ${ARG_TARGET_FILES})
    ...
    if(NOT IS_ABSOLUTE "${destination}")
      set(destination "/home/toby/ThirdYearProject/ros2TurtleBot3_ws/install/hls_lfcd_lds_driver/${destination}")
    endif()
