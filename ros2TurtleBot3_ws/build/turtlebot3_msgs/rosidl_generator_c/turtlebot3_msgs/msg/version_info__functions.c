...
turtlebot3_msgs__msg__VersionInfo__init(turtlebot3_msgs__msg__VersionInfo * msg)
{
  ...
  // hardware
  if (!rosidl_generator_c__String__init(&msg->hardware)) {
    turtlebot3_msgs__msg__VersionInfo__destroy(msg);
    return false;
  }
  // firmware
  if (!rosidl_generator_c__String__init(&msg->firmware)) {
    turtlebot3_msgs__msg__VersionInfo__destroy(msg);
    return false;
  }
  // software
  if (!rosidl_generator_c__String__init(&msg->software)) {
    turtlebot3_msgs__msg__VersionInfo__destroy(msg);
    return false;
  }
  return true;
...
turtlebot3_msgs__msg__VersionInfo__fini(turtlebot3_msgs__msg__VersionInfo * msg)
{
  ...
  // hardware
  rosidl_generator_c__String__fini(&msg->hardware);
  // firmware
  rosidl_generator_c__String__fini(&msg->firmware);
  // software
  rosidl_generator_c__String__fini(&msg->software);
}
